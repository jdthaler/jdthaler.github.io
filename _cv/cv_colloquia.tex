...
\item ``Centaur Science: Adventures in AI+Physics''
\\ Physics Colloquium, \emph{University of Genova, May 2026}
\\ Hans Jensen Lecture, \emph{Heidelberg, April 2026}
\\ Physics Colloquium, \emph{University of Geneva, March 2026}
\\ Colloquium, \emph{CERN, February 2026}

\item ``Descending into the Modular Bootstrap''
\\ Theoretical Physics Colloquium, \emph{Oxford, May 2026}
\\ DAMTP Colloquium, \emph{Cambridge, April 2026}

\item ``Centaur Science:  Particle Physics meets Machine Learning''
\\ Colloquium, \emph{NIKHEF, December 2025}
\\ Physics Colloquium, \emph{NYU, April 2025}
\\ Lauritsen Memorial Lecture, \emph{Caltech, March 2025}
\\ Physics Colloquium, \emph{U. Wisconsin, Madison, February 2025}
\\ Colloquium, \emph{U. Puerto Rico, Mayagüez, February 2025}
...
\\ AlbaNova/Nordita Colloquium, \emph{Stockholm University, February 2021} (virtual)
