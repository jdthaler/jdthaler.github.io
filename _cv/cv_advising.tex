...
\bsbl 
\item Luca Lavezzo \textit{(Christoph Paus, in progress)}
\item Noah Paladino \textit{(Philip Harris, in progress)}
\item Jessica Fry \textit{(Lindley Winslow, in progress)}
\item Shing Yan (Kobe) Li \textit{(Washington Taylor, July 2026)}
\item Zhuo Chen \textit{(Marin Soljacic, April 2026)}
...
\item Cristian Zanoci \textit{(Mikhail Lukin \& Aram Harrow, May 2023)}
...
\bsbl 
\item Anticipated Ph.D. 2031: Dean Ciarniello, Yitao Feng, Tristan Wang
...
\bsbl 
\item Class of 2029: Rohan Bodke, Tejus Deo-Dixit, Davin Li, Eric Mora Jimenez, Maggie Sun
