...
\item ``Centaur Science: Adventures in AI+Physics'', School on Machine Learning and AI Methods at the LHC, \emph{Karachi, Pakistan, July 2026} (virtual)

\item ``Machine Learning through the Lens of Physics'', Learning at the Frontier: Advanced School on Machine Learning for Particle Physics, \emph{AIPHY, June 2026}

\item ``Machine Learning for Fundamental Physics'', Lectures on the Theory of Fundamental Interactions, \emph{GGI, January 2026}

\item ``Centaur Science:  Particle Physics meets Machine Learning'', Chaire Georges Lemaître Lectures, \emph{Université catholique de Louvain, November 2025}
