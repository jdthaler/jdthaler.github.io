...
\setcounter{jessecount}{147}

\begin{list}{[\arabic{jessecount}]\addtocounter{jessecount}{-1}}{\leftmargin=3em \itemsep=4pt}

\item
${}^\ast$ Gregorio de la Fuente and Jesse Thaler,
\emph{Simplex Demixing: Disentangling Multiple Light-Flavor Jets at Colliders}
[arXiv:2607.24921].

\item
 Benjamin Nachman and Jesse Thaler,
\emph{The Well-Tempered Likelihood: Honest Confidence Intervals for Misspecified Models}
[arXiv:2607.20718].

\item
${}^\S$ Rikab Gambhir, Luisa Lucie-Smith, and Jesse Thaler,
\emph{Interpreting 'Interpretability' and Explaining 'Explainability' in Machine Learning in Physics}
[arXiv:2606.26228].

\item
${}^\S$ Umar Sohail Qureshi, Krish Desai, Jesse Thaler, and Benjamin Nachman,
\emph{Reweighting Adversarial Networks for Unbinned Unfolding}
[arXiv:2606.06603].

\item
 Ezequiel Alvarez, Sean Benevedes, Manuel Szewc, and Jesse Thaler,
\emph{Many Wrongs Make a Right: Leveraging Biased Simulations Towards Unbiased Parameter Inference}
[arXiv:2604.02219].

\item
 Samuel Bright-Thonney, Thomas R.\ Harvey, Andre Lukas, and Jesse Thaler,
\emph{Sven: Singular Value Descent as a Computationally Efficient Natural Gradient Method}
[arXiv:2604.01279].

\item
 Nathan Benjamin, A.\ Liam Fitzpatrick, Wei Li, and Jesse Thaler,
\emph{Descending into the Modular Bootstrap}
[arXiv:2604.01275].

\item
 Benoît Assi, Kyle Lee, and Jesse Thaler,
\emph{Improving Parton Shower Predictions via Precision Moments of Energy Flow Polynomials}
[arXiv:2604.00084].
