...
[PDF CV (August 2026)](/pdfs/jthaler_cv_2026_08_02.pdf){:.button.button--secondary.button--pill.button--sm}{:target="_blank"}
...
{% include cv/public_entry.html entry=entry %}
{%- endfor %}
...
[Design Portfolio](/personal#graphic-design){:.button.button--secondary.button--pill.button--sm}
  ...
  * **[Logo Design](design/jthaler_DarkLight_Logo.pdf){:target="_blank"}**, [DarkLight Experiment](https://bateslab.mit.edu/projects/darklight/){:target="_blank"}, *MIT, September 2010*
